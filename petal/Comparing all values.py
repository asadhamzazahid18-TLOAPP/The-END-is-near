...
# ══════════════════════════════════════════════════════════════════
with open('gru_metrics2.json',  'r') as f:
    gru_raw = json.load(f)
with open('lstm_metrics2.json', 'r') as f:
    lstm_raw = json.load(f)
with open('rnn_metrics2.json',  'r') as f:
    rnn_raw = json.load(f)
...
# Lstm models works out better on these datasets more
# LSTM > GRU > RNN
