...
axes[0].set_title('OpenAI — Gru: Actual vs Predicted (Monthly)')
...
plt.tight_layout()
plt.savefig('gru_openai.png', dpi=150)
plt.show()
plt.close()
...
fig2.suptitle("OpenAI GRU Revenue Model — Performance Summary",
              color='white', fontsize=14, fontweight='bold')
plt.tight_layout()
plt.show()

plt.close()
print("Saved → GRU_openai.png   gru_metrics_summary.png")

results = {
    "model": "GRU", "company": "OpenAI", "frequency": "monthly",
...
with open('gru_metrics2.json', 'w') as f:
    json.dump(results, f, indent=2)
print("Saved → gru_metrics2.json")

# Note: Results are based on synthetic data; real-world GRU performance may vary significantly.
